 ...
 * @status 
 */
public class AWs implements TalendJob {
	static {System.setProperty("TalendJob.log", "AWs.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(AWs.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "AWs";
	private final String projectName = "TEJABANALA";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_YP3C0FvKEfCq5LCmxj9RwQ", "0.1");
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TalendException)) {
			AWs.this.exception = e;
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(AWs.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_TEJABANALA_AWs = new byte[0];
    static byte[] commonByteArray_TEJABANALA_AWs = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEJABANALA_AWs.length) {
				if(length < 1024 && commonByteArray_TEJABANALA_AWs.length == 0) {
   					commonByteArray_TEJABANALA_AWs = new byte[1024];
				} else {
   					commonByteArray_TEJABANALA_AWs = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEJABANALA_AWs, 0, length);
			strReturn = new String(commonByteArray_TEJABANALA_AWs, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TEJABANALA_AWs, 0, length);
			strReturn = new String(commonByteArray_TEJABANALA_AWs, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEJABANALA_AWs) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tFileInputDelimited_1", "UzXLP3_");
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"C:/Users/banala teja 04/Downloads/users.csv\"");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "C:/Users/banala teja 04/Downloads/users.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/Users/banala teja 04/Downloads/users.csv", "ISO-8859-15",",","\n",true,1,0,
 ...
 */
	...
	s(currentComponent="tFileInputDelimited_1");
                ...
                if(!((Object)("C:/Users/banala teja 04/Downloads/users.csv") instanceof java.io.InputStream)){
 ...
 */
    ...
    public static void main(String[] args){
        final AWs AWsClass = new AWs();

        int exitCode = AWsClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'AWs' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'AWs' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_YP3C0FvKEfCq5LCmxj9RwQ");
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-07-08T07:19:16.543511300Z");
        ...
        try {
            ...
            java.io.InputStream inContext = AWs.class.getClassLoader().getResourceAsStream("tejabanala/aws_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = AWs.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'AWs' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : AWs");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'AWs' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     76289 characters generated by Talend Cloud Data Management Platform 
 *     on the 8 July 2025 at 12:49:16 pm IST
 ************************************************************************************************/